...
Though `blogdown` and Hugo simplify the creation but there is still a learning curve. In the end, you are left with a single product but breaking down the process into these separate tasks will streamline the workload and isolate debugging.
