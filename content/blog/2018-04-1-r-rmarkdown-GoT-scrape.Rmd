...
If you would like the markdown document used to render this page, you can download it from my . All of the code provided below uses the filepaths specific to my computer. To reproduce just be sure to change these filepaths to match that of your computer and where you'll be saving and loading data.
