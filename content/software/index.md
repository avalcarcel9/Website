...
The `GoT` R package is now live on [GitHub](https://github.com/avalcarcel9/GoT). This package allows you to scrape the Game of Thrones scripts from [www.genius.com](www.genius.com) and some character lists available online. For more information see my [readme](https://github.com/avalcarcel9/GoT/blob/master/README.Rmd) on GitHub and [blog post](http://www.alessandravalcarcel.com/blog/2018-04-1-r-rmarkdown-got-scrape/) about how to use the package.
...
The package is documented using `pkgdown` [here](https://avalcarcel9.github.io/rtapas/). The vignette is hosted [here](https://avalcarcel9.github.io/rtapas/articles/tapas-vignette.html).
